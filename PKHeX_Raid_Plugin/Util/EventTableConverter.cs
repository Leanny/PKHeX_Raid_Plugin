...
namespace PKHeX_Raid_Plugin
{
    public static class EventTableConverter
    {
        ...
        public static void GetCurrentEventTable(SaveBlockAccessor8SWSH blocks, RaidTables rt)
        {
            ...
            var swordTable = new RaidTemplateTable(NestLocations.EventHash, 1, new RaidTemplate[sword_table.EntriesLength]);
            var shieldTable = new RaidTemplateTable(NestLocations.EventHash, 2, new RaidTemplate[sword_table.EntriesLength]);
            ...
            var swordTable_rigel1 = new RaidTemplateTable(NestLocations.EventHash_Rigel1, 1, new RaidTemplate[sword_table.EntriesLength]);
            var shieldTable_rigel1 = new RaidTemplateTable(NestLocations.EventHash_Rigel1, 2, new RaidTemplate[sword_table.EntriesLength]);
            for (int i = 0; i < sword_table.EntriesLength; i++)
            {
                var entry1 = sword_table.Entries(i).Value;
            ...
            var swordTable_rigel2 = new RaidTemplateTable(NestLocations.EventHash_Rigel2, 1, new RaidTemplate[sword_table.EntriesLength]);
            var shieldTable_rigel2 = new RaidTemplateTable(NestLocations.EventHash_Rigel2, 2, new RaidTemplate[sword_table.EntriesLength]);
            for (int i = 0; i < sword_table.EntriesLength; i++)
            {
                var entry1 = sword_table.Entries(i).Value;
        ...
        public static void LoadFromJson(string filecontent, RaidTables rt)
        {
            ...
            var shieldTable = new RaidTemplateTable(NestLocations.EventHash, 2, new RaidTemplate[sword_table[0].Entries.Length]);
